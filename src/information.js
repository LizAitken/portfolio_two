...
import T_five from '../src/images/t5.png';
import T_six from '../src/images/t6.png';
import T_seven from '../src/images/t7.png';
...
import Design from '../src/images/design_icon@2x.png'
    ...
    export const project_info = [
        ...
        },
        {
            ...
            images: [Donate],
            icons: [Build, Design],
            problems: 'One of the most challenging aspects of this application was figuring out the best way for the donators to shop for the items. Initially, I thought of registry for non-profits, but wanted the focus of ease to be on the donator. Usually, registries are based on individual company sites, which would make navigating and seeing how the donator could help, a bit more challenging. Eventually, I landed on making the bookmarklet so that the donations could be individual and therefore easier for the donator.',
